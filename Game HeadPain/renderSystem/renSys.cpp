...
RenderSystem::RenderSystem()
{
	...
	for (int r = 0; r < screenRows; r++)
		for (int c = 0; c < screenColumns; c++)
		{
			...
			m_backBuffer[r][c].symbolColor = CColor_Gray;
			m_backBuffer[r][c].backgroundColor = CColor_Black;
...
void RenderSystem::clear()
{
	for (int r = 0; r < screenRows; r++)
		...
		{
			m_backBuffer[r][c].symbol = 0;
			m_backBuffer[r][c].symbolColor = CColor_Black;
			m_backBuffer[r][c].backgroundColor = CColor_Black;
		}
}

void RenderSystem::drawChar(int r, int c, char symbol, CColor symbolColor, CColor backgroundColor)
{
...
void RenderSystem::drawText(int r, int c, char* text, CColor symbolColor, CColor backgroundColor)
{
	int column = c;
	char symbol = *text;
...
void RenderSystem::setConsoleColor(CColor symbolColor, CColor backgroundColor)
{
